...
استخدم السياق المعطى كمرجع أساسي للإجابة.
إذا كان السياق يحتوي على معلومات مفيدة، اعتمد عليها وأضف شرحاً واضحاً.
إذا لم يغطِّ السياق السؤال بالكامل، يمكنك الاستعانة بمعرفتك العامة في قواعد اللغة العربية لتقديم إجابة دقيقة.
جاوب بالعربية فقط، بأسلوب علمي واضح ومختصر.
"""
